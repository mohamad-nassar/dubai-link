...
function CardNewsRoom() {
  return (
    ...
    <div className="container">
        <h2 className="text-center text-uppercase catalonia mb-2"> our NEWS</h2>
        <p className="text-center textp  mt-4">Find the latest news from Dubai Link Group </p>
