...
function CardPackageHotelThree() {
  return (
    <div>
      <div class="container">
      ...
      <div class="container mt-80">
        <div class="blog-wrapper-hotel pb-5">
          <h2 class="text-center text-capitalize">Radisson Blu Bosphorus Hotel</h2>
          <p class=" paragraphotel text-center mb-1">
            Located on the banks of the Bosphorus, Radisson Blu Bosphorus Hotel offers excellent transport options, as you can easily reach various world-famous destinations, like the Grand Bazaar and Topkapı Palace.
            Delight your palate with fantastic on-site dining options that serve a great variety of mouthwatering house-created gourmet meals you can enjoy against the backdrop of the glorious Bosphorus Bridge. If you’re looking to further treat yourself, head to the Cruise Lounge Bar before or after dinner for an array of cocktails, beers, and wines, or even try a massage or a session in the sauna.
            The Radisson Blu Bosphorus hotel provides you with a wide range of facilities to keep up your workout regime. The hotel features 139 rooms for business or leisure travelers, complete with free Wi-Fi and in-room coffee and tea facilities.
          </p>
        </div>
...
<button class="button-fill-primary text-center d-flex justify-content-center m-auto update-btn2 slide mt-5 mb-5">
  <a class="text-capitalize" href="https://booking.com/">
    visit website
  </a>
</button>
</div>
...
export default CardPackageHotelThree;
