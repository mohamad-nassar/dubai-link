...
function CardApplytwo() {
  return (
    ...
    <div className="container">
        ...
        <h5 class="mb-4">We are looking to hire a sales specialist for our Dubai office with the below requirements: </h5>
