...
function CardApplyfive() {
  return (
    ...
    <div className="container">
        ...
        <h5 class="mb-4">We are looking to hire a sales manager for our cairo office with the below requirements: </h5>
