    ...
    <div>
      <div className="container">
        <ul className=" breadcrumbb mt-5">
          ...
          <li>
            <Link to="/travel-and-tourism">Travel & Tourism</Link>
          </li>
      ...
      <div className="full-width pb-5">
        <div className="container">
          <div className="row justify-content-center">
            <h2 className="text-center text-capitalize text-blog-wrapper hr-lines ">
              Services we do
            </h2>
                        ...
                        <div className="media-content">
                          <div className="hover-content mt-4">
                            ...
                            <h5
                              ...
                              className="rounded-1 bg-white login-red px-4"
                            >
                              {item.title}
                            </h5>
                            <button
                              ...
                              <div className="popup-card">
                                ...
                                <div className="content-popup m-auto">
                                  <img
                                    ...
                                    src="assets/images/dubai/phoneicon.png"
                                  />
                                  <p>
                                    {" "}
                ...
                <div className="col-lg-4 col-md-6 col-12">
                  <div className="box-tour">
                    <div className="img-media">
                      <img
                        className="img-fluid mt-3"
                        src="assets/images/dubai/acoom.png"
                      />
                    </div>
                    <div className="media-content">
                      <div className="hover-content mt-4">
                ...
                <div className="col-lg-4 col-md-6 col-12">
                  <div className="box-tour">
                    <div className="img-media">
                      <img
                        className="img-fluid mt-3"
                        src="assets/images/dubai/holiday.png"
                      />
                    </div>
                    <div className="media-content">
                      <div className="hover-content mt-4">
