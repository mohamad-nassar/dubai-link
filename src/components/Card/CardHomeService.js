...
function CardHomeService() {
  return (
    ...
    <div className="container">
      ...
      <ul className="nav nav-pills flex-column mb-3 " id="pills-tab" role="tablist">
          <li className="nav-link nav-link-none">Days</li>
  ...
  <p>Check-out from hotel.<br />
       ...
       Return flight to your home via Istanbul connection. (Breakfast)</p>
          ...
          <div className="tab-pane fade" id="pills-terms" role="tabpanel" aria-labelledby="pills-terms-tab">
              <div className="container">
                  <h2 className="color-red mb-3">WITH SIC BASIS TOURS + SIC BASIS TRANSFERS</h2>
  <p>
  <ul>
  ...
  <li className="d-flex">  <BsCheck /> <p>The package is subject to availability at the time of booking. 
   The displayed rates do not apply during Christmas, New Year, special events, peak season and blackout dates. Additional 
  <br/> surcharges may apply </p> </li>
