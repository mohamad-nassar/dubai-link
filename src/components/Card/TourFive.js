    ...
    <div>
      <div className="container">
        <ul className=" breadcrumbb mt-5 bread-padding-top">
          ...
          <li>Istanbul - Cappadocia – Istanbul</li>
        </ul>
      </div>
      <div className="container">
              ...
              <table className="table table-bordered table-days ">
                <tbody>
                  ...
                  <tr>
                    ...
                    <p>
                      Panoramic Barcelona city tour to know its main squares,
                      avenues, and monuments like Montjuic Mountain, Passeig de
                      Gracia, Old Port area, Gaudi`sbuildings, etc. Optionally
                      you can visit Sagrada Familia or Park Guell.
                    </p>
                    <br />
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <p>
                        ...
                        Palace, former residence of the Spanish Kings.
                        Optionally, visit the Royal Palace or Prado Museum.
                      </p>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <p>
                        Transfer from the hotel to the train station. Trip from
                        Madrid to Malaga on the AVE(a high‐speed train).
                      </p>
                      <br />
                      <p>Arrival in Malaga and transfer to the hotel.</p>
                      <br />
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <p>Breakfast at the hotel.</p>
                      <p>
                        • Malaga sightseeing tour to the most emblematic places
                        of the city. Optional, you can visit the Malaga
                        Cathedral, Picasso Museum, or Gibral faro Castle.
                      </p>
                    </td>
                  </tr>
              ...
              <div className="container">
                <p>
                  <ul>
                    ...
                    <li>Malaga Sightseeing Tour - 7hrs.</li>
                  </ul>
                </p>
              </div>
            </div>
