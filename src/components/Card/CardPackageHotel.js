    ...
    <div>
      <div class="container">
        <ul class="breadcrumbb mt-5 bread-padding-top">
          ...
          <li>
            <a>The Marmara Sisli Hotel</a>
 </li>
        </ul>
      </div>
      <div class="container mt-80">
        <div class="blog-wrapper-hotel pb-5">
          <h2 class="text-center text-capitalize">The Marmara Sisli Hotel</h2>
          <p class=" paragraphotel text-center mb-1">
            Feel right at home during your stay at The Marmara Sisli Hotel. Go beyond being a tourist and dive deeper into everything İstanbul has to offer with a stay at The Marmara Sisli Hotel, located merely 6.3 km from Hagia Sophia Museum.
            Conveniently situated in the Sisli part of İstanbul, this property puts you close to attractions and interesting dining options. This luxurious hotel is connected to popular areas, such as Taksim Sqaure, and countless historical monuments.
            Stylishly decorated with a modern interpretation of 1950s style, this 4-star hotel provides a range of services and amenities to help make your stay more comfortable.
          </p>
        </div>
...
<h3 className="reviewmobile">3,827 Reviews</h3>

</div>
</div>

<div className="p-last mt-4">
<p>#280 of 2,453 hotels in Istanbul</p>
</div>
...
<div className="w3-container w3-gre w3-round-xlarge" style={{width:"88%"}}></div>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3009.4966358412235!2d28.986378499999997!3d41.0362673!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cab764e83b6691%3A0x424a7b3906d2a73e!2sThe%20Marmara%20Taksim!5e0!3m2!1sen!2slb!4v1673091433103!5m2!1sen!2slb" height="450" style={{width:"100%"}}></iframe>
</div>
</section>
...
<button class="button-fill-primary text-center d-flex justify-content-center m-auto update-btn2 slide mt-5 mb-5">
  <a class="text-capitalize" href="https://www.themarmarahotels.com/en/hotels/sisli">
    visit website
  </a>
</button>
</div>
...
export default CardPackageHotel;
